...
const textMsg = (id: string, role: "user" | "assistant", text: string): UIMessage => ({
  id,
  role,
...
test("MessageList renders assistant messages", () => {
  const messages: UIMessage[] = [
    textMsg("1", "assistant", "I'll help you create a button component."),
  ];
...
test("MessageList shows loading indicator for last assistant message with empty parts", () => {
  const messages: UIMessage[] = [
    {
      id: "1",
      role: "assistant",
